...
import { Form, useLoaderData, useActionData, useNavigate, useTransition } from "@remix-run/react";
...
export default function viewRoute() {
  ...
  return (
    ...
    >
      <p>Manage Note:</p>
      <Form className="form" method="post" reloadDocument key={note?.noteTicketId  ?? null}>
        ...
        <div className="inline actions">
          <button type="submit" name='intent' value='update' className="btn form-btn" disabled={isUpdating}>
